...
epochs = mne.read_epochs('data/segmented-merged-autism-epo.fif')
...
tfr_wav.save("spectrums/segmented-merged-autism-spectrums.fif")
csd_wav.save("spectrums/segmented-merged-autism-csd-spectrum.fif")


#
# tfr_wav.plot()
# plt.suptitle("Wavelet transform")
# tfr_wav.save('autism_spectrums')